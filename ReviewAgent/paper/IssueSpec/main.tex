...
\bottomrule\end{tabular}\end{table}
 ...
 \begin{figure*}[t]\centering
  ...
  selective prediction~\cite{geifman2017selective, bansal2019}; the red loop propagates Stage~5
