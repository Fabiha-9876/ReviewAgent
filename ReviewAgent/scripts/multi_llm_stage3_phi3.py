...
Outputs:
    data/processed/issue_specs/specs_phi3_mini.json
...
OUT_QWEN = BASE / "specs_phi3_mini.json"
...
def main():
    ...
    ap.add_argument("--model-name", default="microsoft/Phi-3-mini-4k-instruct")
    ...
    print(f"Will generate Phi-3 specs for {len(selected)} clusters")
    ...
    print(f"Saved Phi-3 specs: {OUT_QWEN}")
