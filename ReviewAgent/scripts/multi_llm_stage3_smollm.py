...
Outputs:
    data/processed/issue_specs/specs_smollm2_1_7b.json
...
OUT_QWEN = BASE / "specs_smollm2_1_7b.json"
...
def main():
    ...
    ap.add_argument("--model-name", default="HuggingFaceTB/SmolLM2-1.7B-Instruct")
    ...
    print(f"Will generate SmolLM specs for {len(selected)} clusters")
    ...
    print(f"Saved SmolLM specs: {OUT_QWEN}")
